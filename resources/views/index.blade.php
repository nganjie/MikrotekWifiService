      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          ...
          <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
            <h1>manage the distribution of your wifi router efficiently with <span>MikrotekWifi</span></h1>
            <p>Convert your Wi-Fi network into a competitive advantage!</p>
            <div class="d-flex">
