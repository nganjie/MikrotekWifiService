...
function selectOption() {
    ...
    let country_code =this.querySelector('.country-code');
    let country_name=this.querySelector('.country-name');
    document.querySelector('.country').value=country_name.innerText;
    document.querySelector('.country-code').value=country_code.innerText;
